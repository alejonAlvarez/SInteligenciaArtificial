#Lector de señas
#Alejandro Alvarez Marin - Victor 
import cv2
        ...
        if len(results.multi_hand_landmarks):
            for num, hand_landmarks in enumerate(results.multi_hand_landmarks):
                ...
                if thumb_pip[1] - thumb_tip[1] > 0 and thumb_pip[1] - index_finger_tip[1] < 0 \
                    ...
                    cv2.putText(image, 'BIEN', (200, 150), 
                                cv2.FONT_ITALIC, 
                                3.0, (0, 0, 255), 6) 
                ...
                index_finger_pip[1] - index_finger_tip[1] < 0 and \
                 ...
                 ring_finger_pip[1] - ring_finger_tip[1] < 0 and \
                    ...
                    cv2.putText(image, 'Chao', (200, 150), 
                        cv2.FONT_HERSHEY_SIMPLEX, 
                        3.0, (0, 0, 255), 6)
                ...
                if Etiqueta(num, hand_landmarks, results) and len(results.multi_hand_landmarks)==2:
                    ...
                    if change2 == True and change == True:
                        if distancia_euclidiana(index_finger_tip_l,  wrist) < 170.0:
                            cv2.putText(image, 'QUE HORA ES BRO?', (90, 90), 
                                cv2.FONT_HERSHEY_SIMPLEX, 
                                1.0, (0, 0, 255), 6)
